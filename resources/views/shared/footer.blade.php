                ...
                <div class="logo-byhyons">
                    <a class="navbar-brand" href="{{ url('/') }}">
                        <div class="logo_boolbnb mt-5">
                            ...
                            <svg width="40%" height="30%" viewBox="0 0 4000 1459" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:1.5;">
                                <g>
                    ...
                    {{--? IINTESTAZIONE DITTA --}}
                    <div class="credits">
                        <p class="mt-3"> <span class="headline">Boolbnb</span> <br>
                             Team 3 <br>
                            <small>ITALY</small>
                        </p>        
                    </div>
                ...
                <ul class="">
                    ...
                    {{--? modale --}}
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="footer-link dropdown-toggle" href="#" role="button"
